...
namespace Ecotronik\Bundle\EcopointBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Ecotronik\Bundle\EcopointBundle\Entity\productos;
use Ecotronik\Bundle\EcopointBundle\Form\productosType;
...
class productosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ecopointBundle:productos')->findAll();

        return $this->render('ecopointBundle:productos:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ecopointBundle:productos:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ecopointBundle:productos')->find($id);
        ...
        return $this->render('ecopointBundle:productos:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ecopointBundle:productos:edit.html.twig', array(
            'entity'      => $entity,
